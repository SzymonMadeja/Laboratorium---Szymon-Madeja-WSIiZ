...
koszt_podrozy = round(spalanie * cena_paliwa,2) # Obliczenie kosztu podróży. Używamy funkcji round() aby zaokrąglić wynik do 2 miejsc po przecinku
print(f'Samochód spali: {spalanie} litrów paliwa a koszt podróży wynosi: {koszt_podrozy} zł') # Wypisanie tekstu z użyciem zmiennych oraz użycie "f''" co pozwala nam użyć zmienne w łatwiejszy sposóba